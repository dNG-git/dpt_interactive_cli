...
#
	parameters = { "pasInteractiveCliVersion": get_version() }
	...
	setup(name = "pas_interactive_cli",
	      version = get_version(),
	      description = "Python Application Services",
	      long_description = """"pas_interactive_cli" is an extended CLI loader with basic handling for input and output streams.""",
	      author = "direct Netware Group et al.",
	      author_email = "web@direct-netware.de",
	      license = "MPL2",
	      url = "https://www.direct-netware.de/redirect?pas;interactive_cli",
